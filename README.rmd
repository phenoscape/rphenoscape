...
From the list of RNeXML objects, retrieve the character matrices.
```{r}
...
---
<center>[![Phenoscape Knowledgebase](https://wiki.phenoscape.org/wg/phenoscape/images/f/f6/Phenoscape_Logo.png)](http://kb.phenoscape.org)</center>
